...
/**
 * @title CoinEstate Token Upgradeable (CET)
 * @dev Upgradeable version of CoinEstate Token with distribution capabilities
 */
contract CoinEstateTokenUpgradeable is Initializable,
